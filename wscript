...
def configure(conf):
  ...
  flags = ['-O3', '-Wall', '-D_FILE_OFFSET_BITS=64', '-D_LARGEFILE_SOURCE', '-D_MODULE_NAME_NODE_MODULE', '-msse2']
...
def build(bld):
  ...
  obj.cxxflags = ["-D_FILE_OFFSET_BITS=64", "-D_LARGEFILE_SOURCE", "-D_MODULE_NAME_NODE_MODULE", "-O3", "-Wall", "-msse2"]
